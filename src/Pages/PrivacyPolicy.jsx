  ...
  return (
    ...
    <section className='PrivacyPolicySection'>
        <div className='PrivacyPolicyContent'>
            <h5 className='PrivacyPolicyBannerSubHeading'>
            How Do We...
            </h5>
            <h1 className='PrivacyPolicyBannerHeading'>
            Privacy Policy
            </h1>
        </div>
    </section>

    <section className='privacyPolicyMain'>
        <h1 className='PrivacyPolicyHeading'>Privacy Policy</h1>
        <p className="PrivacyPolicyHeadingText">We at Suvidha Mahila Mandal respect your concerns about privacy and value the relationship we have with you. We are committed to the ethical collection, retention and use of information that you provide to us about yourself (“Personal Information”) on our website.
...
<br/><br/>Our Privacy Policy also describes the measures we take to protect the security of the information.
...
<h4 className="PrivacyPolicySubHeading">
How Do We Use Your Information?
</h4>
<p className="PrivacyPolicySubHeadingText">
Suvidha Mahila Mandal uses personally identifiable information you provide about yourself:
</p><br/>
<ul className="PrivacyPolicySubHeadingText">
